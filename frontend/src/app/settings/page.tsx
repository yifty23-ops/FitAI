...
const INPUT_CLASS =
  "w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500";
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pb-20">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <details open className="group bg-zinc-900 border border-zinc-700 rounded-2xl">
          <summary className="cursor-pointer list-none flex items-center justify-between p-4 select-none [&::-webkit-details-marker]:hidden">
            <h2 className="text-sm font-medium text-zinc-300">Subscription</h2>
            <svg className="w-4 h-4 text-zinc-500 transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
          ...
          <div className="px-4 pb-4 space-y-3">
            ...
            {userTier !== "elite" && (
              <p className="text-zinc-500 text-sm">Stripe billing coming soon.</p>
            )}
          </div>
        </details>
        ...
        <details open className="group bg-zinc-900 border border-zinc-700 rounded-2xl">
          ...
          <div className="px-4 pb-4 space-y-4">
            <div>
              ...
              <input type="email" value={userEmail} readOnly className="w-full bg-zinc-800/50 border border-zinc-700 rounded-xl px-3 py-2 text-sm text-zinc-400 cursor-not-allowed" />
            </div>
        ...
        {/* ── Profile Section ── */}
        {profile && (
          <details className="group bg-zinc-900 border border-zinc-700 rounded-2xl">
            <summary className="cursor-pointer list-none flex items-center justify-between p-4 select-none [&::-webkit-details-marker]:hidden">
